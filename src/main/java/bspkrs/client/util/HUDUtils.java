...
public final class HUDUtils
{
    ...
    public static void drawTexturedModalRect(int x, int y, int u, int v, int width, int height, float zLevel)
    {
        ...
        vertexBuffer.addVertexData(new int[] {x, y + height});
        vertexBuffer.pos(zLevel, ((u) * var7), ((v + height) * var8));
        vertexBuffer.addVertexData(new int[] {(x + width), (y + height)});
        vertexBuffer.pos(zLevel, ((u + width) * var7), ((v + height) * var8));
        vertexBuffer.addVertexData(new int[] {(x + width), (y)});
        vertexBuffer.pos(zLevel, ((u + width) * var7), ((v) * var8));
        vertexBuffer.addVertexData(new int[] {(x), (y)});
        vertexBuffer.pos(zLevel, ((u) * var7), ((v) * var8));
        tessellator.draw();
    }
